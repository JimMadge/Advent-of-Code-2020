...
def test_count_valid_passports():
    assert count_valid_passports(process_passports(test_data)) == 2
...
def test_valid_passport2():
    ...
    actual = [valid_passport2(passport) for passport in
              process_passports(test_data2)]

    assert expected == actual


def test_count_valid_passports2():
    assert count_valid_passports2(process_passports(test_data2)) == 4
